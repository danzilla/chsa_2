  ...
  GeoApiService.prototype.fetchChsaResponseSet = function (queriedPoint) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            (longitude = queriedPoint.longitude),
              (latitude = queriedPoint.latitude);
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.axi.get(
                "ows?cql_filter=INTERSECTS(SHAPE,SRID=4326;POINT(" +
                  longStr +
                  latStr +
                  "))",
                {
          ...
          case 2:
            ...
            if (!(contentType && contentType.includes("application/json"))) {
              throw common_nodejs_utils_1.errorWithCode(
                "unable to query chsa response set",
                500
              );
            }
            payload = response.data;
            common_nodejs_utils_1.logger.info(
              "successfully received chsa payload (" +
            ...
            if (features.length === 0) {
              throw common_nodejs_utils_1.errorWithCode(
                "invalid longtitude and latitude for a BC location,        you can use google map to search for the correct and try again ",
                422
              );
            }
            (_a = features[0].properties),
              (CMNTY_HLTH_SERV_AREA_CODE = _a.CMNTY_HLTH_SERV_AREA_CODE),
              (CMNTY_HLTH_SERV_AREA_NAME = _a.CMNTY_HLTH_SERV_AREA_NAME);
            return [
              2 /*return*/,
              {
          ...
          case 3:
            ...
            return [
              2 /*return*/,
              common_nodejs_utils_1.errorWithCode(err_1.message, err_1.code),
            ];
          case 4:
            return [2 /*return*/];
        }
