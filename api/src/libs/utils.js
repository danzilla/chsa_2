...
exports.writeToDbSuccessCallback =
  exports.convertNumToStrFormatForGeoApi =
  exports.isValidLatitude =
  exports.isValidLongitude =
  exports.isEmptyValue =
    void 0;
...
exports.writeToDbSuccessCallback = function (log) {
  try {
    common_nodejs_utils_1.logger.info(
      "successfully wrote log (" + JSON.stringify(log) + ")"
    );
  } catch (err) {
    common_nodejs_utils_1.logger.error(
      "unable to process writeToDbSuccessCallback routine"
    );
  }
};
