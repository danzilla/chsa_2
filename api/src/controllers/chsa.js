...
exports.queryChsaResponseSet = function (req, res) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            shared_1["default"].geo.fetchChsaResponseSet(queriedPoint),
          ];
        case 2:
          rv1 = _b.sent();
          if (rv1 instanceof Error) {
            geo_api_usage_log_1
              .writeGeoApiUsageLog(queriedPoint, {})
              .then(utils_1.writeToDbSuccessCallback);
            throw rv1;
          } else {
            geo_api_usage_log_1
              .writeGeoApiUsageLog(queriedPoint, rv1)
              .then(utils_1.writeToDbSuccessCallback);
...
var validate = function (body) {
  ...
  if (
    !(utils_1.isValidLongitude(longitude) && utils_1.isValidLatitude(latitude))
  ) {
    var message =
      "invalid longitude / latitude input,    make sure the absolute value of longitude is no bigger than 180,    and the absolute value of latitude is no bigger than 90";
    return common_nodejs_utils_1.errorWithCode(message, 400);
  }
  return;
};
